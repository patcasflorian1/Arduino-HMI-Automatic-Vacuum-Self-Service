...
#define ARDUINO_UNO_INTERRUPTED_PIN 18  //X2
...
//EndLed.h
volatile int coinPin = 19;  //3  X3
int inhibitCoin = 49;  //4 Y14
long timeCoinMill = 0;
int limitCoin ;
volatile int coin = 0;
bool insert = false;
...
unsigned long int totalTimeCoin = 0;
  int meniuButton[3] = {27,28,29}; // Meniu,Set, Conta  X5 X6 X7
int  pinReel[] = {12,9,8,48}; //(asp,Parf,negruCauciuc,aerComp) Y12 Y0 Y1 Y15
 int  pinReelSt2[] = {42,6,3,47}; //(asp2,aerComp2,negruCauciuc2,ParfSt2) Y13 Y3 Y4 Y16
