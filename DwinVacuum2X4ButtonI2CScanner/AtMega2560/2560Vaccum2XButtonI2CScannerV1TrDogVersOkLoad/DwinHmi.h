...
void displayTimeHmiSt2(int minutes,int seconds){

  minuteRamaseDisplaySt2[6] = highByte(minutes);
  minuteRamaseDisplaySt2[7]= lowByte(minutes);
  dwinSerial.write(minuteRamaseDisplaySt2, 8);

  secundeRamaseDisplaySt2[6] = highByte(seconds);
  secundeRamaseDisplaySt2[7] = lowByte(seconds);
  dwinSerial.write(secundeRamaseDisplaySt2, 8);
}
